...
class Header extends React.Component {
    ...
    render() {
        ...
        const guestLinks = (
            <ul className="nav navbar-nav navbar-right" style={{marginRight: "5px"}}>
                <li><Link id="white_txt" to={"/Cart"}style={{fontSize:"14px"}}><span className="glyphicon glyphicon-shopping-cart"></span> Cart <span className="badge">{this.props.cart.length}</span></Link></li>
                <li ><Link to={"/SignUp"} id="white_txt" style={{fontSize:"14px"}}  ><span className="glyphicon glyphicon-user "></span> Sign Up</Link></li>
                <li><Link style={{fontSize:"14px"}} to={"/Login"} id="white_txt"  ><span className="glyphicon glyphicon-log-in"></span> Sign In</Link></li>
            </ul>
        );
        return (
            <div>
